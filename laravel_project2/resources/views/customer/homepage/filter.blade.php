    ...
    <div class="container">
        ...
        <div class="row mb-4 mb-sm-5">
            <div class="col-12 text-center">
                <h2 class="mb-0" style="font-family: Inter">Doctor List</h2>
            </div>
        </div>
                    ...
                    <div class="card border-0 h-100" >
                        ...
                        <div class="position-relative bg-white rounded-4">
                            ...
                            <img src="{{asset('./images/' . $doctor->image)}}"
                                 ...
                                 style="height: 390px; overflow: hidden; position: relative">
                            <!-- Overlay -->
                        ...
                        <div class="card-body rounded-4 position-absolute bottom-0"
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <button class="btn bg-black rounded-5 px-lg-5">
                                    <a href="{{route('doctor_detail', $doctor -> id)}}" class="nav-link p-0 text-white"
